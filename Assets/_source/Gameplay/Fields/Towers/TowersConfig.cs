...
namespace Gameplay.Fields.Towers
{
  ...
  public class TowersConfig : IStaticData
  {
    ...
    {
      _bMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.BMaterial);
      _dMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.DMaterial);
      _eMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.EMaterial);
      _gMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.GMaterial);
      _pMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.PMaterial);
      _qMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.QMaterial);
      _rMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.RMaterial);
      _yMaterial = _assetProvider.GetMaterial(Constants.AssetsPath.Materials.YMaterial);
    }
